...
public class MemberServlet extends HttpServlet {
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		for (int i = 0; i < list.size(); i++)
		{
			...
			out.print("<tr><td>" + id + "</td><td>" + pwd + "</td><td>" + name + "</td><td>" + email + "</td><td>" + joinDate + "</td><td>" + "<a href='/proc07/member4?command=delMember&id=" + id + "'> 삭제 </a></td><tr>" );
		}
		out.print("</table>");
		out.print("<a href='/pro07/memberForm.html'>새 회원 가입하기</a></body></html>");
	}
